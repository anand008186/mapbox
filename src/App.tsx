      ...
      fetch("/geojson/catchments_primary_fixed.geojson")
        ...
        .then((data) => {
          ...
          const schoolCentroids: FeatureCollection<Geometry> = {
            ...
            features: data.features.map((feature: any) => {
              ...
              return {
                ...
                properties: { USE_DESC: feature.properties?.USE_DESC },
              };
            }),
          };
          ...
          schoolCentroids.features.forEach((feature) => {
            ...
            // On click, zoom to the catchment and set this school as selected.
            el.addEventListener("click", () => {
              setSelectedSchool({ name: schoolName, coordinates });
